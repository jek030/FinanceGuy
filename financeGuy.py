...
#1
def createLastYearDF(SP500, client):
...
def create5YearDF(top100, client):
    ...
    for ticker in top100:
        ...
        thisYearPrice = 0.0
        i =0
        # need to make a diciontary with ticker-return as key-value pairs
    ...
    #sorts tickers diciontary by percent return
